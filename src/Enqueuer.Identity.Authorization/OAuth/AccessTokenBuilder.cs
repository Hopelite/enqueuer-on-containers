...
//        if (_subjectId != null)
//        {
//            claims.Add(new(JwtRegisteredClaimNames.Sub, _subjectId.ToString(), ClaimValueTypes.Integer64, _configuration.Issuer));
//        }
...
//        token.Header[JwtHeaderParameterNames.Typ] = AccessTokenTypeClaim.Create(_configuration.Issuer).Value;
